...
public class DataLoader {
    ...
    public void init(){
        ...
        List<Post> posts = Arrays.asList(
                new Post(1L,"여행리뷰","여행리뷰제목1","내용1",0,0,LocalDateTime.now(),LocalDateTime.now(),member1,null,null),
                new Post(2L,"여행리뷰","여행사진제목2","내용2",0,0,LocalDateTime.now(),LocalDateTime.now(),member2,null,null)
