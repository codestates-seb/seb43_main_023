...
public class MbtiData {
    ...
    public void init(){
        List<Mbti> mbti = Arrays.asList(
                new Mbti("ISTP","https://mblogthumb-phinf.pstatic.net/MjAyMTA3MDdfMTg1/MDAxNjI1NjQzNzIxNDQz.EfMyjRXUfV1VGRgNszd7a5cVwIDZp9WpZHEzyEC5RJEg.MbHWLTvaIE-96grTDv661p7bK-xyaHpaRmdVBLMTIxog.PNG.im_worry/13.png?type=w800","울릉도, 독도","현실적이지만 대담한 스타일! 예기치 못한 상황도 무난히 해결하는 융통성 있는\nISTP에게 어울리는 울릉도는 어떠신가요?","https://m.segye.com/content/image/2021/06/16/20210616515482.jpg"),
