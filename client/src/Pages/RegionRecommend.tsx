...
function RegionRec() {
	const regionImg = {
		...
		jeju: 'https://images.unsplash.com/photo-1579169825453-8d4b4653cc2c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80',
		gangwon:
		...
		jeonnam: 'https://cdn.gjdream.com/news/photo/202101/605746_205437_2251.jpg',
		jeonbuk:
		...
		chungnam: 'https://cdn.imweb.me/thumbnail/20190505/5cce19e7b096e.jpg',
		chungbuk: 'http://noms.templestay.com/images/TiImage/H/L/9569.png',
	};
		...
		<RegionRecContainer>
			...
			<RegionRecItemContainer>
				<Link to="/regiondetail">
					<RegionRecImg image={regionImg.seoul}>
						<div>서울</div>
					</RegionRecImg>
				</Link>
				<RegionRecImg image={regionImg.jeju}>
					<div>제주</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.gangwon}>
					<div>강원</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.gyeonggi}>
					<div>경기</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.busan}>
					<div>부산</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.ulsan}>
					<div>울산</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.daegu}>
					<div>대구</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.daejeon}>
					<div>대전</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.incheon}>
					<div>인천</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.gwangju}>
					<div>광주</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.gyeongnam}>
					<div>경상남도</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.gyeongbuk}>
					<div>경상북도</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.jeonnam}>
					<div>전라남도</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.jeonbuk}>
					<div>전라북도</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.chungnam}>
					<div>충청남도</div>
				</RegionRecImg>
				<RegionRecImg image={regionImg.chungbuk}>
					<div>충청북도</div>
				</RegionRecImg>
			</RegionRecItemContainer>
		</RegionRecContainer>
