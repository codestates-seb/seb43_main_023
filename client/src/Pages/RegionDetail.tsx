...
function RegionDetail() {
	...
	return (
		<RegionDetailContainer>
			<RegionDetailImage image="https://img1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/cnoC/image/4yPtuRXtR0-jusOMCCXb4MeN6zU.jpg">
				<span>{selectedRegion[0].name} 추천 여행 명소</span>
			</RegionDetailImage>
			<RegionInfo>
				<RegionInfoImg image="https://img1.daumcdn.net/thumb/R1280x0.fjpg/?fname=http://t1.daumcdn.net/brunch/service/user/cnoC/image/4yPtuRXtR0-jusOMCCXb4MeN6zU.jpg" />
				<RegionInfoText>
					<Weather>
						<WeatherTitle>
			...
			<RegionTitle>📍{selectedRegion[0].name}의 명소</RegionTitle>
