...
function RegionDetail() {
	...
	const tourUrl = `https://apis.data.go.kr/B551011/KorService1/areaBasedList1?serviceKey=${tourAPIKey}&pageNo=${curPage}&numOfRows=6&MobileApp=AppTest&MobileOS=ETC&arrange=Q&contentTypeId=12&areaCode=${selectedRegion[0].areaCode}&_type=json`;
